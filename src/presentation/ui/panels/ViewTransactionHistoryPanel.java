...
public class ViewTransactionHistoryPanel extends JPanel {
    private JTextField accountIdField;
    private JTextArea detailsArea;

    public ViewTransactionHistoryPanel() {
        setLayout(new GridBagLayout());
        setBorder(BorderFactory.createTitledBorder("See transaction history"));
